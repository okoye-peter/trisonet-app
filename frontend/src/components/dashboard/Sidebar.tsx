...
const sidebarItems = [
    ...
    { icon: CircleDollarSign, label: 'Wards Fees', href: '/dashboard/fees' },
    {
        ...
        hasSubmenu: true,
        subItems: [
            { label: 'Transfers', href: '/dashboard/finance/transfers', icon: ArrowRightLeft },
            { label: 'Transactions', href: '/dashboard/finance/transactions', icon: ScrollText },
            { label: 'Utility Bills', href: '/vtu', icon: Receipt },
            { label: 'Wallet', href: '/dashboard/finance/wallet', icon: Wallet },
            { label: 'Gkwth Business', href: '/dashboard/finance/gkwth', icon: Briefcase },
